...
<div class="breadcrumb-section style-2" style="background-image:linear-gradient(rgba(248, 248, 248, 0.5), rgba(248, 248, 248, 0.5)), url(assets/img/innerpage/breadcrumb-bg6.jpg);">
    ...
    <div class="container-lg container-fluid">
        <div class="banner-wrapper">
                ...
                <div class="row align-items-center gy-5">
                    <div class="col-lg-7">
                        ...
                        <div class="dash-and-paragraph">
                            ...
                            <p>We remain at the top of execellence on every service and products we offer to our clients.</p>
                        </div>
                    </div>
                    <div class="col-lg-5 d-flex justify-content-xxl-center">
            ...
            <ul class="breadcrumb-list">
                <li><a href="index.php"><?= sitename ?></a></li>
                <li>Portfolio</li>
            </ul>
        </div>
    </div>
...
<div class="pf-shoecase-page pt-130 mb-130">
    <div class="container-lg container-fluid">
        <div class="row">
            <div class="col-lg-12">
                <div class="filters filter-button-group">
                    <ul>
                        ...
                        <li data-filter=".Branding">Business Mgt.</li>
                        <li data-filter=".UiUx">Marketing</li>
                        <li data-filter=".Web">Media Mgt.</li>
                        <li data-filter=".Graphics">Software</li>
                    </ul>
                </div>
            </div>
        </div>
        <div class="row g-4 grid mb-70">
            <div class="col-lg-4 col-sm-6 grid-item Branding UiUx">
                <div class="single-portfolio-sw">
                    <div class="pf-shw-img">
                        <img src="assets/images/image-416x505 (7).jpg" alt>
                    </div>
                    <div class="pf-shw-content-wrap">
                        <a class="publish-date"><b>©2018 - till date</b></a>
                        <div class="pf-shw-content text-center">
                            <h4><a> Tekhub <br> </a></h4>
                            <a>Business Development & Management/Marketing</a>
                        </div>
                        <div class="pf-shw-content text-center">
                            <p style="font-size: 12px;">
                                Our job has been helping to grow this company's business development utilizing strategies and programs, searching out new possibilities, boasting profits through our solutions.
                            </p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-sm-6 grid-item Branding Graphics Web">
                <div class="single-portfolio-sw">
                    <div class="pf-shw-img">
                        <img src="assets/images/image-416x505 (6).jpg" alt>
                    </div>
                    <div class="pf-shw-content-wrap">
                        <a class="publish-date"><b>©2019 - till date</b></a>
                        <div class="pf-shw-content text-center">
                            <h4><a href="product-details.html">Euro Gold Hotel<br> and Suites</a></h4>
                            <a>Network and Hotel Development & Management.</a>
                        </div>
                        <div class="pf-shw-content text-center">
                            <p style="font-size: 12px;">
                                We provided solutions to the development & management of the business, and also digitalizated most of it’s business processes and corporate technical support.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-4 col-sm-6 grid-item Graphics">
                <div class="single-portfolio-sw">
                    <div class="pf-shw-img">
                        <img src="assets/images/image-416x505 (2).jpg" alt>
                    </div>
                    <div class="pf-shw-content-wrap">
                        <a class="publish-date"><b>©2019 - till date</b></a>
                        <div class="pf-shw-content text-center">
                            <h4><a>Winnie Bakery</a></h4>
                            <a>Inentory & CCTV Installation</a>
                        </div>
                        <div class="pf-shw-content text-center">
                            <p style="font-size: 12px;">
                                Our company installed the networking, Inventory system of the business, and also managed it's software design & installation. We also procuremed hardware supplies and provided corporate technical supports.
                            </p>
                        </div>
                    </div>
                </div>
            </div>
            <!-- <div class="col-lg-4 col-sm-6 grid-item Web UiUx ">
                <div class="single-portfolio-sw">
                    <div class="pf-shw-img">
                    ...
                    <div class="pf-shw-content-wrap">
                        <a class="publish-date" ><b>©2018 - till date</b></a>
                        <div class="pf-shw-content text-center">
                            <h4><a> Modern Design <br> Solutions</a></h4>
                            <a>Modern</a>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-4 col-sm-6 grid-item Branding UiUx">
                <div class="single-portfolio-sw">
                    <div class="pf-shw-img">
                        <img src="assets/images/image-416x505 (3).jpg" alt>
                    </div>
                    <div class="pf-shw-content-wrap">
                        <a class="publish-date"><b>©2024</b></a>
                        <div class="pf-shw-content text-center">
                            <h4><a> Hilton Liesure <br> Hotel & Suites</a></h4>
                            <a>Business Development & Marketing</a>
                        </div>
                        <div class="pf-shw-content text-center">
                            <p style="font-size: 12px;">
                                We implemented structures that maintain the existing positive business development management and marketing atmosphere.
                                Part of our job was enhancing patronage and profitings, by deploying strategic outreach, collaborative marketing campaigns,feed back/response system design.
                                ....and more!!
                            </p>
                        </div>
                    </div>
            ...
            <div class="col-lg-4 col-sm-6 grid-item Graphics ">
                <div class="single-portfolio-sw">
                    <div class="pf-shw-img">
                        <img src="assets/images/image-416x505 (5).jpg" alt>
                    </div>
                    <div class="pf-shw-content-wrap">
                        <a class="publish-date"><b>©2024</b></a>
                        <div class="pf-shw-content text-center">
                            <h4><a> Okeb Nig. Limited <br> Solutions</a></h4>
                            <a>Mgt. Software Solution. Computerization of Business process and Technical Support.</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-sm-6 grid-item Web ">
                <div class="single-portfolio-sw">
                    <div class="pf-shw-img">
                        <img src="assets/images/image-416x505 (4).jpg" alt>
                    </div>
                    <div class="pf-shw-content-wrap">
                        <a class="publish-date"><b>©2024</b></a>
                        <div class="pf-shw-content text-center">
                            <h4><a> Hilton Liesure <br> Hotel Resort</a></h4>
                            <a>Social Media Platforms Management & Promotions</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-sm-6 mx-auto grid-item Branding UiUx">
                <div class="single-portfolio-sw">
                    <div class="pf-shw-img">
                        <img src="assets/images/image-1000x1000.jpg" alt>
                    </div>
                    <div class="pf-shw-content-wrap">
                        <a class="publish-date"><b>©2018 - till date</b></a>
                        <div class="pf-shw-content text-center">
                            <h4><a> Senatorch Limited</a></h4>
                            <a>Business development & Management</a>
                        </div>
                        <div class="pf-shw-content text-center">
                            <p style="font-size: 12px;">
                                As a team we deploy strategic business development plans, advertisement strategies, marketing campaigns, concept development, and response systems designs prioritizing growth in the company. We also created a positive professional business atmosphere, promoting services & client relations.
                            </p>
                        </div>
                    </div>
                </div>
            </div>
            <!-- <div class="col-lg-4 col-sm-6 grid-item border-half UiUx ">
                <div class="single-portfolio-sw">
                    <div class="pf-shw-img">
                        <img src="assets/images/circle.png" alt>
                    </div>
                    <div class="pf-shw-content-wrap">
                        <a class="publish-date" href="#"><b>©2018 - till date</b></a>
                        <div class="pf-shw-content text-center">
                            <h4><a>...And more</a></h4>
                            <a>UI/UX Design</a>
                        </div>
...
<!-- Mirrored from demo-egenslab.b-cdn.net/html/axleo/preview/portfolio-manonery.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 04 Apr 2024 15:22:09 GMT -->
