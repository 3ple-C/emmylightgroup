                            ...
                            <div class="footer-widget">
                                ...
                                <div class="menu-container">
                                    <ul>
                                        ...
                                        <li>
                                            <a href="./service.php">Advertisements
                                                <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 10 10">
                                                    <path d="M8.33624 2.84003L1.17627 10L0 8.82373L7.15914 1.66376H0.849347V0H10V9.15065H8.33624V2.84003Z" />
                                                </svg>
                                            </a>
                        ...
                        <div class="col-lg-12">
                            <div class="footer-logo-contact-wrap">
                                <div class="footer-logo">
                                    <a href="./index.php"><img src="assets/images/emmylogo_home.png" alt="footer-logo"></a>
                                </div>
                                <ul class="footer-contact">
                                    <li class="single-contact">
                                        <span>Phone</span>
                                        <h5><a href="tel:<?=sitephone?>"><?=sitephone?></a></h5>
                                    </li>
                                    <li class="single-contact">
                                        <span>Email Now</span>
                                        <h5><a href="mailto:<?=siteemail?>"><?=siteemail?></a>
                                        </h5>
                                    </li>
                                </ul>
                            </div>
