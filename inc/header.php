    ...
    <div class="sidebar-area">
        <div class="sidebar-menu-top-area">
            ...
            <div class="sidebar-menu-logo">
                <a class="logo-dark" href="index.php"><img alt="image" class="img-fluid" src="assets/images/emmylogo_home.png"></a>
                <a class="logo-light" href="index.php"><img alt="image" class="img-fluid" src="assets/images/emmylogo_home.png"></a>
            </div>
    ...
    <header class="header-area style-2">
        <div class="logo-and-menu">
            ...
            <div class="header-logo">
                <a href="index.php"><img alt="image" class="img-fluid" src="assets/images/emmylogo_home.png"></a>
            </div>
            <div class="main-menu">
                <!-- mobile logo -->
                <div class="mobile-logo-area d-lg-none d-flex justify-content-between align-items-center">
                    <div class="mobile-logo-wrap">
                        <a href="index.php"><img alt="image" src="assets/images/emmylogo_home.png"></a>
                    </div>
                </div>
        ...
        <div class="nav-right d-flex jsutify-content-end align-items-center">
            ...
            <a href="contact.php" class="header-btn btn-hover">
                Get in Touch
                <span></span>
            </a>
        </div>
