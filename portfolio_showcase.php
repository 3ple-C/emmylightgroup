...
<div class="pf-shoecase-page pt-130 mb-130">
    <div class="container-lg container-fluid">
        ...
        <div class="row g-4 grid mb-70">
            <div class="col-lg-4 col-sm-6 grid-item UiUx Web Graphics ">
                <div class="single-portfolio-sw">
                    ...
                    <div class="pf-shw-content-wrap">
                        <a class="publish-date" href="#">©2024</a>
                        <div class="pf-shw-content text-center">
                            <h4><a href="portfolio-details.html"> Digital <br> Masterpieces</a></h4>
                            <a href="portfolio-showcase.html">UI/UX Design</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-sm-6 grid-item Branding ">
                <div class="single-portfolio-sw">
                    ...
                    <div class="pf-shw-content-wrap">
                        <a class="publish-date" href="#">©2024</a>
                        <div class="pf-shw-content text-center">
                            <h4><a href="product-details.html"> Branding <br> Design </a></h4>
                            <a href="portfolio-showcase.html">Branding</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-sm-6 grid-item UiUx Graphics ">
                <div class="single-portfolio-sw">
                    <div class="pf-shw-img">
                    ...
                    <div class="pf-shw-content-wrap">
                        <a class="publish-date" href="#">©2024</a>
                        <div class="pf-shw-content text-center">
                            <h4><a href="portfolio-details.html"> Digital <br> Solutions</a></h4>
                            <a href="portfolio-showcase.html">Creative</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-sm-6 grid-item Web UiUx ">
                <div class="single-portfolio-sw">
                    ...
                    <div class="pf-shw-content-wrap">
                        <a class="publish-date" href="#">©2024</a>
                        <div class="pf-shw-content text-center">
                            <h4><a href="portfolio-details.html"> Modern Design <br> Solutions</a></h4>
                            <a href="portfolio-showcase.html">Modern</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-sm-6 grid-item Branding Web ">
                <div class="single-portfolio-sw">
                    <div class="pf-shw-img">
                    ...
                    <div class="pf-shw-content-wrap">
                        <a class="publish-date" href="#">©2024</a>
                        <div class="pf-shw-content text-center">
                            <h4><a href="portfolio-details.html"> Sculpting the <br> Future</a></h4>
                            <a href="portfolio-showcase.html">Creative</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-sm-6 grid-item Graphics UiUx ">
                <div class="single-portfolio-sw">
                    <div class="pf-shw-img">
                    ...
                    <div class="pf-shw-content-wrap">
                        ...
                        <div class="pf-shw-content text-center">
                            <h4><a href="portfolio-details.html"> Digital <br> Solutions</a></h4>
                            <a href="portfolio-showcase.html">Design</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-sm-6 grid-item UiUx Web ">
                <div class="single-portfolio-sw">
                    <div class="pf-shw-img">
                    ...
                    <div class="pf-shw-content-wrap">
                        <a class="publish-date" href="#">©2024</a>
                        <div class="pf-shw-content text-center">
                            <h4><a href="portfolio-details.html"> Branding <br> Design</a></h4>
                            <a href="portfolio-showcase.html">Branding</a>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-4 col-sm-6 grid-item UiUx ">
                <div class="single-portfolio-sw">
                    <div class="pf-shw-img">
...
<!-- Mirrored from demo-egenslab.b-cdn.net/html/axleo/preview/portfolio-showcase.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 04 Apr 2024 15:22:24 GMT -->
