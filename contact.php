    ...
    <div class="container-lg container-fluid">
        ...
        <div class="section-title six mb-70">
            ...
            <div class="dash-and-paragraph">
                ...
                <p>We are committed to building long-term business relationships based on integrity, originality, performance, value, and innovations to our client’s satisfaction.</p>
            </div>
        </div>
                            ...
                            <div class="single-location mb--30">
                                ...
                                <ul>
                                    <li>
                                        ...
                                        <div class="info">
                                            <a href="tel:2348035210924"><?= sitephone ?></a>
                                            <a href="tel:2348063415504"><?= sitephone2 ?></a>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="icon">
                                        ...
                                        <div class="info">
                                            ...
                                            <a href="mailto:<?= siteemail2 ?>"><?= siteemail2 ?></a>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="icon">
                                ...
                                <ul>
                                    <li>
                                        ...
                                        <div class="info">
                                            ...
                                            <a href="tel:<?= sitephone2 ?>"><?= sitephone2 ?></a>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="icon">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-inner mb-30">
                                        ...
                                        <input type="text" placeholder="+234- 8066 **** ****">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-inner mb-30">
...
<!-- Mirrored from demo-egenslab.b-cdn.net/html/axleo/preview/contact.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 04 Apr 2024 15:22:55 GMT -->
